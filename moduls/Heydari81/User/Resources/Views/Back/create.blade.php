                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                    ...
                                    <div class="form-group smalls">
                                        <label>نام</label>
                                        <input type="text" name="name" required class="form-control" placeholder="احمد پورمخبر">
                                    </div>

                                    <div class="form-group smalls">
                                        <label>نام کاربری</label>
                                        <input type="text" name="slug" required class="form-control" placeholder="ahmad1200">
                                    </div>
                                    <div class="form-group smalls">
                                        <label>ایمیل</label>
                                    ...
                                    <div class="form-group smalls">
                                        <ul class="lists-4">
                                            <div class="drios">
                                                ...
                                                <input id="l22" class="checkbox-custom" value="completed" name="status" type="radio">
                                ...
                                <div class="tab-pane fade" id="v-pills-seo" role="tabpanel" aria-labelledby="v-pills-seo-tab">
                                    <div class="form-group smalls">
                                        <label>هدلاین</label>
                                        <input type="headline" class="form-control" placeholder="عنوان ">
                                    </div>

                                    <div class="form-group smalls">
                                        <label>بیوگرافی</label>
                                        <textarea name="bio" class="summernote"></textarea>
                                    </div>
