                        ...
                        <div class="crs_log_wrap">
                            ...
                            <div class="crs_log__caption">
                                ...
                                <div class="rcs_log_124">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn full-width btn-md theme-bg text-white">اعمال تغییرات</button>
                                    </div>
                                </div>
                            </div>
                            <div class="crs_log__footer d-flex justify-content-between">
                                <div class="fhg_45"><p class="musrt">هنوز ثبت نام نکرده اید؟<a href="{{route('register')
                                    }}" class="theme-cl">ثبت نام</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
