                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                    ...
                                    <div class="form-group smalls">
                                        ...
                                        <input type="text" value="{{$season->title}}" name="title" required class="form-control" placeholder="">
                                        @error('title')
                                        <hr>
                                    ...
                                    <div class="form-group smalls">
                                        <label>اولویت</label>
                                        <input type="number" name="priority" value="{{$season->priority}}" class="form-control" placeholder="">
                                        @error('priority')
                                        <hr>
                                        <h7 class="btn-outline-danger">{{ $message }}</h7>
                                        <hr>
                                ...
                                <div class="tab-pane fade" id="v-pills-requirements" role="tabpanel" aria-labelledby="v-pills-requirements-tab">
                                    ...
                                    <div class="form-group smalls">
                                        <ul class="lists-4">
                                            <div class="drios">
                                                <label>حالت کنونی{{$season->status}}میباشد</label>
