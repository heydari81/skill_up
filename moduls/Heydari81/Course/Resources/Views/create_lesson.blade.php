    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="dashboard_wrap">
            <div class="form_blocs_wrap">
                <form method="POST" action="{{route('lessons.store',$course->id)}}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel"
                                    ...
                                    <div class="form-group smalls">
                                        ...
                                        <input type="text" name="title" required class="form-control"
                                               placeholder="تدریس ریاضی و آمار دهم انسانی">
                                        @error('title')
                                        <hr>
                                    ...
                                    <div class="form-group smalls">
                                        <label>اولویت</label>
                                        <input type="number" name="priority" class="form-control" placeholder="اولویت">
                                        @error('priority')
                                        <hr>
                                        <h7 class="btn-outline-danger">{{ $message }}</h7>
                                        <hr>
